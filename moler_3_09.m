...
%moler_3_09  Runge's polynomial interpolation example.
%   F(x) = 1/(1+25*x^2)
%   Interpolazione tramite polinomio con punti distribuiti secondo i nodi di Chebyshev tra: -1 <= x <= 1.
%   L'interpolazione converge in tutto l'intervallo tra -1 <= x <= 1.
...
% numero dei punti di interpolazione di Chebyshev.
