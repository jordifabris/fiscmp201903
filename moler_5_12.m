...
contour(X,Y,Z,[0 0],'r');
disp('si vede quindi come nonostante siano state applicate delle perturbazioni complessivamente e singolarmente');
disp('il valore dei coefficienti varia al più nell ordine di grandezza e-2');
